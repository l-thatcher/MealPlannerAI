...
export default function Subscriptions() {
  ...
  const getPlanFeatures = (planName: string) => {
    ...
    if (name.includes("basic") || name.includes("starter")) {
      return [
        "5 AI-generated meal plans per month",
  ...
  return (
    <div className="flex min-h-screen flex-col items-center p-4 sm:p-8 md:p-12 lg:p-24">
      {/* Animated Background */}
      <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
      ...
      <div className="w-full max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-300 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            ...
            personalized nutrition tracking, and seamless grocery list
            generation.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8">
          {plans.map((plan, index) => {
            ...
            const isPopular = isPremiumPlan(plan.name) && index === 1; // Middle plan is popular
