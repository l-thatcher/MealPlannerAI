...
export const getUserPrompt = (formData: MealPlannerFormData): string => {
  return [
    ...
    '',
    'Meal names must be generic (e.g., "Breakfast", "Lunch", "Dinner", "Morning Snack"). Do NOT use creative or custom meal labels.',
    ...
    `- Calories: ${formData.calories ?? 2200} kcal`,
    `- Protein: ${formData.protein ?? 150} g`,
    `- Carbohydrates: ${formData.carbs ?? 200} g`,
    `- Fats: ${formData.fats ?? 80} g`,
    '',
